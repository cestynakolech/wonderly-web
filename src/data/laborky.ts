...
export const laborky: Record<string, Laborka> = {
	...
	'fyzika/7-rocnik/sily-kolem-nas/sila': {
		...
		postup: [
			...
			'Nakonec přidej 200 g a pak 300 g, vždy přidej další závaží a opět odečti sílu F₂, F₃.',
	...
	'fyzika/8-rocnik/mechanicka-prace-a-vykon/mechanicka-prace': {
		nazev: 'Kolik práce vykonáme při zvedání závaží?',
		cil: 'Vypočítat mechanickou práci při zvedání různých závaží do stejné výšky a ověřit, jak práce závisí na síle.',
		pomucky: ['závaží o hmotnostech 100 g, 200 g a 300 g (nebo stejně těžké sáčky s mincemi)', 'provázek', 'metr', 'lepicí páska'],
		postup: [
			'Na stěně vyznač páskou dvě značky přesně 1 m nad sebou. Spodní značka musí být tak vysoko, aby zavěšené závaží neleželo na podlaze.',
			'Přivaž na provázek závaží o hmotnosti 100 g. Přidrž je u spodní značky a plynule je zvedni ke značce horní.',
			'Převeď hmotnost na kilogramy a vypočítej tíhovou sílu F = m · g. Pro školní výpočet použij g = 10 N/kg.',
			'Vypočítej vykonanou práci podle vztahu W = F · s. Dráha zvedání je pokaždé s = 1 m.',
			'Měření a výpočet zopakuj se závažími 200 g a 300 g. Výsledky zapiš do tabulky.',
			'Porovnej, kolikrát se zvětšila síla a práce oproti závaží 100 g.',
		],
		tabulka: {
			sloupce: ['hmotnost (g)', 'hmotnost (kg)', 'síla F (N)', 'dráha s (m)', 'práce W (J)', 'násobek práce'],
			radky: 3,
		},
		otazky: [
			'Jakou práci vykonáš při zvednutí závaží 100 g o 1 m?',
			'Proč je práce při zvednutí závaží 300 g třikrát větší než u závaží 100 g?',
			'Vykonal(a) bys mechanickou práci, kdybys závaží jen držel(a) u horní značky bez pohybu? Vysvětli.',
		],
		pozor: 'Používej jen lehká závaží, zkontroluj pevné uvázání a nestůj pod zavěšeným předmětem.',
		tip: 'Závaží 100 g má při školním zaokrouhlení g = 10 N/kg tíhovou sílu 1 N. Při zvednutí o 1 m proto vykonáš práci právě 1 J.',
	},
