...
{
  "jednotky": [
    "výkon elektrárny — značíme P, jednotka W (watt); v energetice MW (megawatt)",
    "vyrobená nebo spotřebovaná energie — značíme E, jednotka Wh (watthodina); v energetice MWh (megawatthodina); základní jednotka je joule, 1 Wh = 3 600 J",
    "1 MWh = energie při výkonu 1 MW po dobu 1 hodiny"
  ],
  "body": [
    "obnovitelné: v přírodě neomezené, samy se doplňují",
    "obnovitelné: sluneční záření, vítr, voda, geotermální proudy",
    "obnovitelné: biomasa, bioplyn, vodík",
    "čerpat jen tak rychle, jak se obnoví",
    "neobnovitelné: omezené množství, časem se vyčerpají",
    "fosilní paliva: uhlí, ropa, zemní plyn",
    "vznik: zbytky organismů bez přístupu vzduchu",
    "neobnovitelné: ropné břidlice a písky, jaderné palivo",
    "elektrárny: jaderné, tepelné, sluneční, větrné",
    "elektrárny: vodní, geotermální",
    "jaderná elektrárna: palivo obohacený uran 235",
    "vodík: obnovitelný zdroj, ale nosič energie",
    "vodík se vyrábí elektrolýzou vody",
    "skoro vše je uložená sluneční energie",
    "výjimky: jaderná, geotermální, přílivová energie",
    "sluneční a větrné: výkon nejde poručit",
    "elektřina se ve velkém špatně skladuje",
    "přečerpávací elektrárna: baterie z vody",
    "v noci čerpá vodu do horní nádrže",
    "přes den vypouští vodu, roztáčí turbínu"
  ]
}
```

## ZDROJE
- PDF „21. Obnovitelné a neobnovitelné zdroje energie" (SmartBooks) obsahuje jen výtah — sám má poznámku „Toto Stručné vysvětlení učiva obsahuje pouze základy z tohoto tématu" (str. 4). Proto je dosavadní blok temata.ts (bohatší, dlouho ověřený) hlavní kostrou; PDF slouží k ověření a doplnění drobností.
- Úvodní věta „Přírodní zdroje energie... dělíme do dvou skupin" → PDF str. 1 („Přírodní zdroje energie, které využíváme pro výrobu elektrické energie nebo pohon strojů, lze rozdělit do dvou kategorií"), shoda s dosavadním blokem.
- Definice obnovitelných zdrojů → PDF str. 1 doslovně: „Látky, které se nacházejí na naší planetě v neomezeném množství / Nelze je vyčerpat." Dosavadní blok (slug `obnovitelne-a-neobnovitelne-zdroje`) měl „doplňují se tak rychle, jak je stačíme využívat" a větu „«Obnovitelný» ale neznamená «nevyčerpatelný»: les vykácený rychleji, než stačí dorůst, nebo přetížený geotermální vrt dojdou stejně jako uhlí. Rozhoduje rychlost, jakou se zdroj obnovuje, ne jeho množství." — obě věty v OBSAH zůstávají vedle definice z PDF. Sousedství „neomezené množství" (výčet) a „mohou dojít stejně jako uhlí" (vysvětlující odstavec hned za ním) je vědomé — PDF má přednost u definice, nuanci řeší následující věta.
- Výčet obnovitelných zdrojů (sluneční záření, vítr, tekoucí voda, geotermální proudy, biomasa a bioplyn, vodík) → PDF str. 1, shoda s dosavadním blokem. Termín „geotermální teplo" opraven na „geotermální proudy" podle PDF (rozpor mezi zdroji, přednost PDF).
- Vodík jako obnovitelný zdroj i jako „nosič energie" → vodík je v PDF str. 1 uveden mezi obnovitelnými zdroji; nuance o výrobě elektrolýzou a nosiči energie je z dosavadního bloku temata.ts, PDF ji neobsahuje (rozšíření nad útržkovitý podklad, dosavadní obsah ponechán).
- Definice a výčet neobnovitelných zdrojů (omezené množství, fosilní paliva ze zbytků odumřelých organismů bez přístupu vzduchu, ropné břidlice a písky, jaderné palivo) → PDF str. 1, shoda s dosavadním blokem.
- Druhy elektráren (jaderné, tepelné, sluneční, větrné, vodní, geotermální) → PDF str. 2, shoda s dosavadním blokem. Doplněno slovo „zpravidla obohacený" u uranu 235 → PDF str. 2, doslovně „palivem je zpravidla obohacený uran 235" (dosavadní blok měl jen „uran 235").
- Oddíl „Skoro všechno je vlastně sluneční energie" (vítr, voda, biomasa, uhlí a ropa jako uložená sluneční energie; jaderná, geotermální a přílivová energie jako výjimky) → v PDF není, jde o obsah dosavadního bloku temata.ts.
- Slabina obnovitelných zdrojů (výkon nejde poručit, špatná skladovatelnost elektřiny) → v PDF přímo není, je to dosavadní blok.
- Přečerpávací elektrárna Dlouhé stráně — princip ukládání energie čerpáním vody z dolní do horní nádrže v noci a vypouštěním přes turbínu s generátorem přes den ve špičce → PDF str. 3–4, shoda s dosavadním blokem.
- Příklad výpočtu (čerpadla 500 MW, turbíny 750 MW, 8 h čerpání = 4 000 MWh, 4 h výroby = 3 000 MWh, ztráta 1 000 MWh = 25 %) → VLASTNÍ PŘÍKLAD z dosavadního bloku temata.ts, v PDF není. Přepočítáno: 500 × 8 = 4 000, 750 × 4 = 3 000, 4 000 − 3 000 = 1 000, 1 000 : 4 000 = 25 %; vše sedí, čísla celá.
- Otázky „Zamysli se / Z praxe" (sluneční elektrárna jako jediný zdroj pro nemocnici, smysl ztrátové přečerpávací elektrárny, vodík jako obnovitelný zdroj) → VLASTNÍ PŘÍKLADY z dosavadního bloku temata.ts, v PDF nejsou.
- ZAPIS.body: druhy elektráren doloženy PDF str. 2, vodík jako nosič energie dosavadním blokem.
