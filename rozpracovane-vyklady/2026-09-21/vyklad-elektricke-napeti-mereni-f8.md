...
<p>Přenosné zdroje mají menší napětí. <strong>Akumulátor</strong> je dobíjecí baterie — najdeme ji v mobilu, v notebooku i v autě. Autobaterie má napětí kolem <strong>12 V</strong>, nabíjení mobilu a notebooku přes USB-C kabel bývá zhruba <strong>5 až 20 V</strong>.</p>
...
<p>Voltmetr, který umí měřit i střídavé napětí, se přepólováním <strong>nepoškodí</strong> — jen u stejnosměrného napětí ukáže zápornou hodnotu. Obyčejný ručkový voltmetr na stejnosměrné napětí se ale přepólováním poškodit může, proto na pořadí svorek dáváme pozor.</p>
...
- USB-C nabíjení: PDF str. 1 uvádí přesně „20 V", dosavadní blok `elektricke-napeti-mereni` má rozsah „~5–20 V" → ROZPOR mezi zdrojem a webem, k rozhodnutí učitele; ponecháno dosavadní znění (rozsah), aby se nic dosavadního nevyřadilo
...
- DOPLNĚNO (chybělo v předchozí verzi tohoto návrhu, nález kontroly 21. 9. 2026): „zapojením více zdrojů za sebou se zvýší napětí i proud v obvodu" → PDF str. 3, doslovný citát; zapracováno do OBSAH (odstavec „Zapojení více zdrojů za sebou") i do ZAPIS.body
...
- OPRAVENO (kontrolor 21. 9. 2026, bod 1): voltmetr schopný měřit i střídavé napětí se přepólováním svorek nepoškodí, jen u stejnosměrného napětí ukáže zápornou hodnotu → PDF str. 5, doslovně: „voltmetr, který umí měřit i střídavé napětí, při špatném zapojení (+) a (-) nepoškodíme, ale bude u stejnosměrného napětí ukazovat zápornou hodnotu proudu". Věta „obyčejný ručkový voltmetr na stejnosměrné napětí se přepólováním poškodit může" je upřesnění kontrolora (logicky plyne z kontrastu v PDF větě, ale doslovně v PDF není) — ponecháno podle pokynu kontroly, k případnému ověření učitelem
...
- OPRAVA POZNÁMKY (kontrolor 21. 9. 2026, bod 2): předchozí verze tohoto návrhu tvrdila „žádná další látka k doplnění nebyla nalezena" — bylo to nepravdivé, protože věta o růstu proudu při sériovém řazení (PDF str. 3) tehdy ve výkladu chyběla a byla doplněna až touto opravou (viz bod výše). Zdrojové PDF je útržek SmartBooks (končí odkazem „číst dál" na placený obsah); veškerý dostupný text z dosažitelných stran 1–6 je nyní ve výkladu zapracován
