...
<p>Do obvodu zapojíme žárovku, <strong>ampérmetr</strong> (měří proud I) a <strong>voltmetr</strong> (měří napětí U). Postupně zvyšujeme napětí na zdroji a pokaždé odečteme proud. Výsledek je jasný: <strong>kolikrát se zvětší napětí, tolikrát se zvětší proud</strong>. V grafu proudu podle napětí je to přímka, která vychází z počátku.</p>

<h3>Znění zákona</h3>
<p><strong>Elektrický proud I procházející vodičem je přímo úměrný napětí U mezi konci vodiče.</strong> Konstantou této úměrnosti je fyzikální veličina <strong>elektrický odpor R</strong> — čím větší odpor vodič má, tím méně je ochoten napětí měnit v proud.</p>
...
<p>Odpor samotného vodiče (drátu) bývá zanedbatelný. Mnohem důležitější je odpor zapojených spotřebičů, třeba žárovky nebo topné spirály vařiče — jejich odpor rozhoduje, kolik proudu obvodem poteče.</p>
...
<p>Horší vodič propustí při stejném napětí 10 V jen proud 0,1 A: R = 10 : 0,1 = <strong>100 Ω</strong> — poloviční proud znamená dvojnásobný odpor.</p>
...
```json
{
  ...
  "jednotky": [
    ...
    "Převody: 1 mA = 0,001 A,  1 kV = 1 000 V,  1 kΩ = 1 000 Ω,  1 MΩ = 1 000 000 Ω.",
  ...
  "zakon": "Elektrický proud I procházející vodičem je přímo úměrný napětí U mezi konci vodiče.",
  "body": [
...
- Doslovné znění zákona „Elektrický proud I procházející vodičem je přímo úměrný napětí U mezi konci vodiče." → PDF str. 2, doslovný citát. Dosavadní blok temata.ts měl v poli `zapis.zakon` navíc větu „a nepřímo úměrný elektrickému odporu R" — to v PDF není doslovná součást citátu zákona, proto v ZAPIS.zakon ponechána jen přesná citace; vztah k R zůstává vysvětlen v OBSAH (odstavec „Znění zákona").
...
- Definice odporu „popisuje míru, s jakou vodič brání průchodu elektrického proudu", jednotka ohm (Ω), čtení „óm", měřidlo ohmmetr → PDF str. 3 — nová látka z PDF, dosud ve webu chyběla, doplněno
- Odpor samotného vodiče zanedbatelný vs. důležitost odporu spotřebičů (žárovka, topná spirála vařiče) → PDF str. 5 — nová látka z PDF, dosud ve webu chyběla, doplněno
...
- Příklad „10 V, 0,1 A → 100 Ω" (horší vodič) → dosavadní blok temata.ts. ROZPOR: PDF str. 5 uvádí pro „horší vodič" jiné hodnoty (10 V, 0,05 A → 200 Ω). Dosavadní číslo ponecháno (pravidlo „dosavadní se nevyřazuje"), rozpor k rozhodnutí učitele.
- Násobné a dílčí jednotky odporu: 1 mΩ = 0,001 Ω, 1 kΩ = 1 000 Ω, 1 MΩ = 1 000 000 Ω → PDF str. 4. Dosavadní ZAPIS.jednotky měl jen „1 mA = 0,001 A, 1 kV = 1 000 V, 1 kΩ = 1 000 Ω" — doplněn chybějící převod „1 MΩ = 1 000 000 Ω" z PDF, ostatní ponechány beze změny.
