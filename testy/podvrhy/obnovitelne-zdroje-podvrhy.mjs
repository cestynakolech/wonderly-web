...
const WORKDIR = mkdtempSync(join(tmpdir(), 'obnovitelne-zdroje-podvrh-'));
const KOPIE = join(WORKDIR, 'obnovitelne-zdroje-podvrh.astro');
...
const PODVRHY = [
	...
	['výchozí režim je čerpání místo výroby (horniProcent obráceně)', (s) => s.replace("let cilHorniProcent = 20;\n\tlet rezim = 'vyrabet';", "let cilHorniProcent = 80;\n\tlet rezim = 'cerpat';")],
