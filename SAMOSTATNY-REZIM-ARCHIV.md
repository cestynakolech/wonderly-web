...
## ⬇️ Přesunuto 16. 8. 2026 ze SAMOSTATNY-REZIM.md (nedělní audit — hotová kola 12.–15. 8. 2026, beze změny)
...
### Kandidáti na simulace — HOTOVO, přesunuto z Fronty nápadů 16. 8. 2026
...
<!-- přesunuto z SAMOSTATNY-REZIM.md (řádky 133–169) 19. 8. 2026, beze změny obsahu -->
...
<!-- přesunuto z SAMOSTATNY-REZIM.md (řádky 235–452) 19. 8. 2026, beze změny obsahu -->
...
## Přesun 6. 9. 2026 — uzavřené audity a stav k 19.–22. 8. 2026 (zkrácení startovního čtení)
...
### ~~ÚKOL — POSÍLIT BRÁNU `testy/uniky.mjs`, měří jen část úniků~~ — ✅ HOTOVO 22. 8. 2026
5 kol nezávislé kontroly (0→146→83→154→116→112 nálezů měřidla), oprava 106 textů + 5 přepočtů,
výsledek 0 úniků, nasazeno (commit `cbbebb9`).
...
### Revize starších simulací — dávky 1–7 (22. 8. 2026, dokončeno 37/37)
...
### Drobné dluhy ze sloučení Saint-Sauveur (12. 8. 2026) + úklid 22. 8. 2026 večer
