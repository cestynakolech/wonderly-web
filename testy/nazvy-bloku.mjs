 ...
 */
const SIMULACE_SE_SCRATCHEM = ['VetveniSimulace', 'OpakovaniSimulace', 'PromenneSimulace', 'SouradniceSimulace', 'LedDisplejSimulace', 'UdalostiSimulace', 'VlastniBlokySimulace', 'BludisteSimulace', 'KlonovaniSimulace'];
