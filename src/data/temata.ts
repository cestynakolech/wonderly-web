	...
	'fyzika/8-rocnik': [
		{
			...
			podtemata: [
				...
				},
				{
					...
					interakce: 'ucinnost',
					obsah: "<h2>Účinnost (nad rámec RVP)</h2>\n<p>Kolik elektřiny vysavač spotřebuje a kolik z ní skutečně využije na sání? Žádný stroj nevrátí přesně tolik užitečné práce, kolik do něj vložíme — vždy je aspoň malá ztráta. Poměr mezi tím, co stroj skutečně využije, a tím, co do něj vložíme, popisuje veličina <strong>účinnost</strong>.</p>\n\n<h3>Příkon a výkon</h3>\n<p>Každý stroj má dvě strany. Na jedné straně do něj energie <strong>vstupuje</strong>. Kolik jí do stroje vstoupí za jednu sekundu, udává <strong>příkon</strong>, značíme <strong>P₀</strong> (čti „pé nula\"). Například u vysavače je to elektrický příkon, který bere ze zásuvky.</p>\n<p>Na druhé straně stroj koná <strong>užitečnou</strong> práci. Jak rychle ji koná, udává <strong>užitečný výkon</strong>, značíme <strong>P</strong>. U vysavače je to výkon na hubici, kterým skutečně nasává prach a nečistoty.</p>\n<p>Příkon i výkon se měří ve stejné jednotce — <strong>wattech (W)</strong>.</p>\n\n<h3>Vzorec účinnosti</h3>\n<p style=\"font-size:1.3rem\"><strong>η = P : P₀</strong></p>\n<p>Účinnost značíme řeckým písmenem <strong>η</strong> (éta). Spočítáme ji tak, že užitečný výkon P vydělíme příkonem P₀. Výsledek obvykle udáváme v <strong>procentech</strong> — vynásobíme ho stem.</p>\n<p>Účinnost je vždy <strong>menší než 100 %</strong>. Žádný stroj totiž nepromění celou dodanou energii v užitečnou práci — část se vždy ztratí, nejčastěji jako <strong>teplo</strong> (tření součástek, odpor vodičů) nebo hluk.</p>\n<p>Stejně se účinnost počítá i z energie: kolik energie stroj užitečně využil, vydělíme energií, kterou dostal. U motorů proto říkáme, že motor promění na pohyb jen část energie paliva a zbytek uteče jako odpadní teplo.</p>\n\n<h3>Příklad: kladkostroj</h3>\n<p>Kladkostroj má výkon 0,4 kW a příkon 0,48 kW. Jeho účinnost je:</p>\n<p>η = P : P₀ = 0,4 : 0,48 ≐ 0,83 = <strong>83 %</strong></p>\n<p>Kladkostroj tedy využije asi 83 % dodané energie, zbylých asi 17 % se ztratí hlavně třením v kladkách a laně.</p>\n\n<h3>Pro zvídavé: počítáme</h3>\n<p>Motor výtahu zvedne rovnoměrným pohybem náklad o hmotnosti 240 kg do výšky 36 m za 90 s.</p>\n<p>Nejdřív spočítáme výkon motoru. Tíhová síla nákladu: F<sub>g</sub> = m · g = 240 · 10 = 2 400 N (g = 10 N/kg). Práce: W = F · s = 2 400 · 36 = 86 400 J. Výkon: P = W : t = 86 400 : 90 = <strong>960 W</strong>.</p>\n<p>Jaký je příkon motoru, když jeho účinnost je η = 96 %?</p>\n<p>P₀ = P : η = 960 : 0,96 = <strong>1 000 W</strong></p>\n<p>A jaký příkon by potřeboval starší parní stroj se stejným výkonem 960 W? Parní stroje měly účinnost jen asi <strong>15 % až 20 %</strong> — u stroje z našeho příkladu počítáme s η = 20 %.</p>\n<p>P₀ = P : η = 960 : 0,2 = <strong>4 800 W</strong></p>\n<p>Parní stroj by tedy ke zvednutí stejného nákladu potřeboval skoro pětkrát větší příkon než motor výtahu z našeho příkladu.</p>",
					zapis: {"vzorec":"η = P : P₀      (odvozeně: P = η · P₀,  P₀ = P : η)","vzorecSlovy":"účinnost = užitečný výkon děleno příkonem","jednotky":["účinnost — značíme η (éta), udává se v procentech (%)","příkon — značíme P₀, jednotka W (watt); výkon, který do stroje vstupuje (dodaná energie za sekundu)","výkon — značíme P, jednotka W (watt); užitečný výkon, který stroj skutečně využije","příkon i výkon dosazujeme ve stejné jednotce (např. oba ve W, nebo oba v kW)"],"body":["účinnost: kolik z dodané energie stroj skutečně využije","příkon P₀: výkon, který do stroje vstupuje","výkon P: užitečný výkon, který stroj využije","η = P : P₀","stejný poměr platí i pro energii: využitá energie : dodaná energie","účinnost se udává v procentech","účinnost je vždy menší než 100 %","ztráta: nejčastěji teplo (tření, odpor) nebo hluk","kladkostroj: η = 0,4 : 0,48 ≐ 0,83 = 83 %","výtah: P = 960 W, η = 96 % → P₀ = 1 000 W","parní stroj: malá účinnost (asi 15–20 %); při 960 W a η = 20 % → P₀ = 4 800 W","nižší účinnost = větší příkon potřeba pro stejný výkon"]},
				},
			],
		},
		{
